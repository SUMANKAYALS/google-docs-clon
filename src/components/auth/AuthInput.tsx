    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <div className="relative flex items-center">
          {Icon && (
            <Icon
              className={`absolute left-3.5 size-4 transition-colors duration-200 pointer-events-none ${error
                  ? "text-rose-500"
                  : isFocused
          ...
          <input
            ...
            className={`w-full h-11 text-sm font-medium rounded-xl bg-zinc-50/70 dark:bg-zinc-950/70 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-600 border transition-all duration-200 focus:outline-none ${Icon ? "pl-10" : "pl-3.5"
              } pr-3.5 ${error
